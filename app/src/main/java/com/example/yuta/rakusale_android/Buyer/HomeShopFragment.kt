 ...
 * [HomeShopFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [HomeShopFragment.newInstance] factory method to
...
class HomeShopFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment HomeShopFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                HomeShopFragment().apply {
